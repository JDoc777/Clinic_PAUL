...
inline constexpr long PULSES_PER_REV = 360;  // TODO: adjust to your hardware
...
void readEncoder4() {                  // BACK RIGHT
  int b = digitalRead(ENCB_BR);
  if (b) posi4++; else posi4--;
