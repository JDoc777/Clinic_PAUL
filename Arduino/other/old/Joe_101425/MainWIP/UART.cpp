...
//if statement for each flag - done
//work in servo.cpp and .h
//creeate 1 function to put each servo into apply command
//create previous function in servo files and call it in apply command
