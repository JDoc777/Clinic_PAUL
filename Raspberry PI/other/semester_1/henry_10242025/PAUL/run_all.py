...
def main():
    ...
    Payload.set_flags_byte(shared_data, 0b11101111)  # example: set flags directly (LED1 + RESET)
    #Payload.set_buzzer(shared_data, 4, 50)  # example: set buzzer to 4.50 seconds
    ...
    #Payload.set_motors(shared_data, fl=255, fr=255, rl=255, rr=255)  # example: set all motors forward at 100
