...
# ------------------- CONFIG / TUNABLES -------------------
ENABLE_GRAPHS = False
CLAW_STEP_SIZES = [2, 3, 1, 4, 5]  # degrees per step for each servo
...
def main():   
    ...
    controller = start_claw_controller(step_sizes=CLAW_STEP_SIZES, transition_delay=CLAW_TRANSITION_DELAY, shared_data=shared_data)
