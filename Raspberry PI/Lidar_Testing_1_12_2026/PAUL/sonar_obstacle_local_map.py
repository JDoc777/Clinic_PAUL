...
class SonarObstacleLocalMap:
    def __init__(self, sonar_processor, shared_data=None, poll=0.05):
        ...
        self.L_raw = 0
        self.R_raw = 0
        self.F_sonar_angle_fused = 0
        self.R_sonar_angle_fused = 0
        self.L_sonar_angle_fused = 0
        self.B_sonar_angle_fused = 0
        self._running.set()
...
##########################################################################################################################################################################
    ...
    def fused_sonar_obstacle_axis_processing(self, fused_pose):
        ...
        def fix_distance(raw_distance):
            ...
            return raw_distance / 100  # Convert cm to m
        
        self.F_obstacle_x_fused, self.F_obstacle_y_fused = self.F_calculate_obstacle_positions(fused_pose['theta'], fix_distance(self.F_raw), self.F_sensor_pos_fused)
